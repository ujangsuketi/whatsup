...
<ul class="flex flex-row justify-center pb-3 -ml-4 -mr-4 text-sm font-bold">
    ...
    @endif
    @if (config('wpbox.fb','#')!="#")
        <a href="{{ config('wpbox.fb','#') }}" class="text-gray-400 hover:text-gray-500">
    ...
    @endif
    @if (config('wpbox.insta','#')!="#")
        <a href="{{ config('wpbox.insta','#') }}" class="text-gray-400 hover:text-gray-500">
    ...
    @if (config('wpbox.tw','#')!="#")
        <a href="{{ config('wpbox.tw','#') }}" class="text-gray-400 hover:text-gray-500">
